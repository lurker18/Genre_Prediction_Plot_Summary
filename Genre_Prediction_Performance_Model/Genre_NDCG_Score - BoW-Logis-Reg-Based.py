...
# Train
clf.fit(train_sentence_vectors, y_train)
# Valid
#clf.fit(valid_sentence_vectors, y_val)


# Prediction of Y
# Train
train_y_pred = clf.predict(train_sentence_vectors)

# Validation
#valid_y_pred = clf.predict(valid_sentence_vectors)

# Test
test_y_pred = clf.predict(test_sentence_vectors)
...
# Controlling the Threshold from 0.5 --> 0.3
#y_pred_prob = clf.predict_proba(test_sentence_vectors)
#t = 0.3
#y_pred_new = (y_pred_prob >= t).astype(int)
#f1_score(y_test, y_pred_new, average = 'micro')
#f1_score(y_test, y_pred_new, average = 'macro')
...
def infer_genres(q):
    ...
    q_pred = clf.predict(sentence_vectors)
